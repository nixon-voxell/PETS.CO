var xmlns = "http://www.w3.org/2000/svg",
  ...
  container = select('.container-food'),
...
{
  mousePos.x = ((stageWidth/2) - e.offsetX*2) * -1;
  mousePos.y = ((stageHeight/2) - e.offsetY*2) * -1;
  ...
  TweenMax.to(bone, 1, {
    x: e.offsetX*2 - (bone.getBBox().width/2),
    y: e.offsetY*2 - (bone.getBBox().height/2),
