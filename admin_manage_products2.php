...
<div class="container">
  ...
  <div class="rounded-card-parent">
    <div class="card rounded-card">
      <span class="card-title orange-text bold" style="padding-left: 20px;">Create Product</span>
      <form action="admin_manage_products2.php" method="POST" style="padding-left: 10px;">
        <div class="row">
